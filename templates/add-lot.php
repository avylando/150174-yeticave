...
<form class="form form--add-lot container <?=!empty($errors) ? "form--invalid" : "";?>" action="../add.php" method="post" enctype="multipart/form-data">
    ...
    <div class="form__container-three">
        <div class="form__item form__item--small <?=isset($errors['price']) ? "form__item--invalid" : "";?>">
            ...
            <input id="lot-rate" type="number" name="price" placeholder="0" value="<?=isset($lot['price']) ? $lot['price'] : "";?>">
        ...
        <div class="form__item <?=isset($errors['date']) ? "form__item--invalid" : "";?>">
            ...
            <input class="form__input-date" id="lot-date" type="date" name="date" value="<?=isset($lot['date']) ? $lot['date'] : "";?>">
