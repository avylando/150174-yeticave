...
<?php if (!empty($lots)): ?>
    ...
    <ul class="pagination-list">
        <li class="pagination-item pagination-item-prev">
            <a href="<?=($current_page > 1) ? 'all-lots.php?category_id=' . $category_id . '&page=' . ($current_page - 1) : ''?>">Назад</a>
        </li>
        ...
        <li class="pagination-item pagination-item-next">
            <a href="<?=($current_page < $pages_number) ? 'all-lots.php?category_id=' . $category_id . '&page=' . ($current_page + 1) : ''?>">Вперед</a>
        </li>
    </ul>
    <?php endif; ?>
<?php else: ?>
